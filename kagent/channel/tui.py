...
class TUIApp(App):
    ...
    def __init__(self, message_handler: Optional[Callable[[str, str], Awaitable[str]]], session_id: str):
        super().__init__()
    ...
    async def on_input_submitted(self, event: Input.Submitted) -> None:
        ...
        if self.message_handler:
            try:
                ...
                response = await self.message_handler(user_text, self.session_id)
...
class TUIChannel(BaseChannel):
    ...
    def start(self):
        ...
        self.app = TUIApp(self.message_handler, self.session_id)
        self.app.run()
